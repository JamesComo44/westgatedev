<?php
/**
 * Theme Plugin Name: Taxonomy Term Image
 * Theme Plugin URI: https://github.com/daggerhart/taxonomy-term-image
 * Description: Adds an image upload field to a taxonomy term edit page using WordPress 4.4 taxonomy term meta data
 * Author: daggerhart, slack
 * Theme Integration Author: James Como
 * Version: 2.0.3
*/
...
class Taxonomy_Term_Image {
	...
	/**
	 * Init the theme plugin and hook into WordPress
	 */
...
/**
 * Initialize the theme plugin by calling for its instance on WordPress action 'init'
 */
